...
Output
```js
console.log(a);          // write to the browser or Node.js console
...
x = 100 % 48;    // modulo. 11/ 48 remainder = 4
...
Dates
```js
Fri Jan 20 2023 22:03:00 GMT-0600 (Central Standard Time)

var d = new Date();

1674273780402 miliseconds passed since 1970
